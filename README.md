...
This tooling uses the linkages generated by _esbuild_ to create
<!-- a dependency graph -- not yet -- see https://github.com/CycloneDX/cyclonedx-esbuild/issues/11 --> an inventory
which only contain the dependencies that are actually used (after [tree-shaking](https://esbuild.github.io/api/#tree-shaking)).
